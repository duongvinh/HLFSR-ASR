...
def MI2StackView(x, angRes):
	...
	[b,c,H, W] = out.size()
	h0, w0 = int(H // angRes), int(W // angRes)

	out = out.view(b,c, angRes, h0, angRes, w0).permute(0,1,2,4,3,5)
	out = out.reshape(b,c*angRes*angRes, h0, w0)
